...
int boolCopyStatsFromToSlot(int indexPokemon, int livello, int slotScelto,
                            int copyName, int copyIndex, int copyMaxHp,
                            int copyHp, int copyAtk, int copyDef, int copySpd,
                            int copyLvl) {
  if (copyName)
